...
When downloading a workout, I cant tell how long the download will take | ? | 1 | ? | ?  |Progress Bar for download.|
...
| The go-back arrow is too small and may easily be missable. | ? | 0 | ? | ? | Make the arrow bigger or the label around the arrow bigger to easily go back. |
...
| On the workout page, the most important information (the workout itself) is placed after additional content, which violates common navigation standards, as users expect the main content to be positioned at the top of the page. | 3 | 2 | ? | ? | Move the workout section to the top of the page to follow common interface standards, improving navigation and making it easier for users to find the main content. |
